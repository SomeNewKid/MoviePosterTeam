...
get_movie_illustration_tool = function_tool(get_movie_illustration)
get_movie_details_tool = function_tool(get_movie_details)
get_movie_poster_tool = function_tool(get_movie_poster)
